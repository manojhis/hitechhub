...
function wcsc_run( $forced = false ) {
    ...
    if ( is_wp_error( $result ) ) {
        if ( $result->get_error_code() === 'wcsc_notice' ) {
            ...
            $msg .= __( '<p>This may indicate a problem with your server\'s permissions, resources, or general WordPress setup.  If you need support, please contact your website host or post to the <a href="https://wordpress.org/support/forum/how-to-and-troubleshooting/">main WordPress support forum</a>.</p>', 'wcsc' );
