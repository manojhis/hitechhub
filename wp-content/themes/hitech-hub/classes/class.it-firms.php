    ...
    class ITFirms{
        ...
        */
        ...
        public static function itf_enqueue_styles_cb(){
            ...
            wp_enqueue_style('hightechhub-bootstrap-min-css', IT_HIPL_THEME_DIR . '/assets/css/bootstrap.min.css', array(), $version, 'all');
			wp_enqueue_style('hightechhub-header-min-css', IT_HIPL_THEME_DIR . '/assets/css/header.min.css', array(), $version, 'all');
			wp_enqueue_style('hightechhub-footer-min-css', IT_HIPL_THEME_DIR . '/assets/css/footer.min.css', array(), $version, 'all');
			
			//Single Blog
			if(is_single() && get_post_type() == 'blog'){
				wp_enqueue_style('hightechhub-blog-details-min-css', IT_HIPL_THEME_DIR . '/assets/css/blog-details.min.css', array(), $version, 'all');
			}
			
			//Single Interview
			if(is_single() && (get_post_type() == 'interview' || get_post_type() == 'press-release')){
				wp_enqueue_style('hightechhub-interview-details-min-css', IT_HIPL_THEME_DIR . '/assets/css/interview-details.min.css', array(), $version, 'all');
			}
			...
			//Add a company
			if(is_page(array(70, 'get-listed'))){
    			wp_enqueue_style('hightechhub-add-company-min-css', IT_HIPL_THEME_DIR . '/assets/css/add-company.min.css', array(), $version, 'all');
				wp_enqueue_style('hightechhub-add-select2-min-css', IT_HIPL_THEME_DIR . '/assets/libs/select2/select2.min.css', array(), $version, 'all');
			}
			
			//Blogs 
			if(is_page(array(755, 'blogs'))){
    			wp_enqueue_style('hightechhub-blog-min-css', IT_HIPL_THEME_DIR . '/assets/css/blog.min.css', array(), $version, 'all');
			}
			
			//Contact Us 
			if(is_page(array(5848, 'contact-us'))){
    			wp_enqueue_style('hightechhub-contact-us-min-css', IT_HIPL_THEME_DIR . '/assets/css/contact-us.min.css', array(), $version, 'all');
			}
			
			//Find Agency
			if(is_page(array(5852, 'find-an-agency'))){
    			wp_enqueue_style('hightechhub-select2-min-css', IT_HIPL_THEME_DIR . '/assets/libs/select2/select2.min.css', array(), $version, 'all');
				wp_enqueue_style('hightechhub-get-proposal-min-css', IT_HIPL_THEME_DIR . '/assets/css/get-proposal.min.css', array(), $version, 'all');
			}
			
			//Home page
			if(is_page(array(867)) || is_front_page()){
    			wp_enqueue_style('hightechhub-index-min-css', IT_HIPL_THEME_DIR . '/assets/css/index.min.css', array(), $version, 'all');
			}
			
			//Interview
			if(is_page(array(8522, 'interviews'))){
    			wp_enqueue_style('hightechhub-interviews-min-css', IT_HIPL_THEME_DIR . '/assets/css/interviews.min.css', array(), $version, 'all');
			}
			
			//Press Release
			if(is_page(array(8530, 'press-releases'))){
    			wp_enqueue_style('hightechhub-press-interviews-min-css', IT_HIPL_THEME_DIR . '/assets/css/interviews.min.css', array(), $version, 'all');
			}
			
			//Privacy Policy
			if(is_page(array(6212, 'privacy-policy'))){
    			wp_enqueue_style('hightechhub-policy-page-min-css', IT_HIPL_THEME_DIR . '/assets/css/policy-page.min.css', array(), $version, 'all');
			}
			
			//Sponsored
			if(is_page(array(6236, 'badges'))){
    			wp_enqueue_style('hightechhub-sponsored-min-css', IT_HIPL_THEME_DIR . '/assets/css/sponsored.min.css', array(), $version, 'all');
			}
            ...
            wp_enqueue_script('hightechhub-bootstrap-bundle-min-js', get_template_directory_uri() . '/assets/libs/bootstrap/js/bootstrap.bundle.min.js', array('jquery'), $version, true);

            wp_enqueue_script('hightechhub-main-js', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), $version, true);

            wp_enqueue_script('hightechhubFunctions-js', get_template_directory_uri() . '/assets/js/hightechhubFunctions.js', array('jquery'), $version, true);
            ...
            wp_localize_script( 'hightechhubFunctions-js', 'itfirmsScriptData', $itfirmsScriptdata );
