...
get_header();
?> 
<link rel="stylesheet" href="<?php echo IT_HIPL_THEME_DIR;?>/assets/css/interviews.min.css">
...
<section class="interview-section section-spacing">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-12">
                <div class="interview-card-group"><?php 
                if($query->have_posts()) :
                    while($query->have_posts()) : $query->the_post(); 
                        ...
                        <div class="interview-card">
                            <div class="interview-banner"><img src="<?php echo $attachment_url; ?>" alt="interview"></div>
